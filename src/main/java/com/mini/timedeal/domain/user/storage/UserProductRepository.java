...
//    private final Map<Long, User> users = new HashMap<>();
    ...
    public UserProductRepository() {
        ...
        promotions.put(1L, new Promotion(1L, 10, 100, LocalDateTime.now(), LocalDateTime.now().plusMinutes(3)));
//        userProducts.add(new UserProduct(1L, 1L, 1L, LocalDateTime.now()));
    }
